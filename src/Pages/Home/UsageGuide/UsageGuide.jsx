...
const UsageGuide = () => {
  return (
    <div className="my-20 animate-fade animate-duration-[3000ms] animate-delay-100">
      ...
      <p className="leading-relaxed md:text-xl text-lg my-4">
        ...
        assignments. Easily create and organize tasks, track your progress, and
        mark them as completed once finished. Our shared assignment feature
        allows users to post assignments for others while protecting the
        original post. Here’s how it all works:
      </p>
      <div className="space-y-4 my-5">
        ...
        <p className="md:text-xl text-lg leading-relaxed">
          ...
          Teachers can review and grade submitted assignments, offering feedback
          and scores that are visible to students. Once reviewed, students can
          remove the assignment from their view if they wish.
        </p>
      </div>
    </div>
  );
