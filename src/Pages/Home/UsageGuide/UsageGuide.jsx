      ...
      <div className="my-20 animate-fade animate-duration-[3000ms] animate-delay-100">
        ...
        <AnimatedComponent animation="fade-up">
          <p className="leading-relaxed md:text-xl text-lg my-4">
            ...
            feature allows users to post assignments for others, while
            protecting the original post. Here’s how it all works:
          </p>
          <div className="space-y-4 my-5 ">
            <p className="md:text-xl leading-relaxed">
              ...
              <p className="md:text-xl text-lg leading-relaxed">
                ...
                the original poster can delete it, ensuring secure
                collaboration.
              </p>
              <p className="md:text-xl  text-lg leading-relaxed">
                3.{" "}
